...
ui <- navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
                 ...
                 tabPanel("Ueber diese Webseite",
                          tags$div(
                            ...
                            tags$br(),
                            tags$h4("Umsetzung"),
                            "Aufgrund der Tatsache, dass wir ein zwei Personen Team sind und somit unsere Ressourcen eingeschraenkt sind haben wir begonnen mit einem Fork des Dashboards:",tags$br(),
                            tags$a(href="https://github.com/eparker12/nCoV_tracker", "https://github.com/eparker12/nCoV_tracker"), 
                            tags$br(), tags$br(),
