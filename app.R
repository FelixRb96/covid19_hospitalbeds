...
ui <- navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
                 ...
                 tabPanel("Ueber diese Webseite",
                          tags$div(
                            tags$h4("Idee und Impact"),
                            "Wir erstellen einen Proof of Concept um:", tags$br(),

                                "Daten von Krankenhauskapazitaeten zusammenzutragen", tags$br(),
                                "diese interaktiv in einer Karte gegen die aktuelle Lage der Coronafaelle zu visualisieren", tags$br(), tags$br(), 
                                "Krankenhaeusern, Behoerden oder anderen Gruppen wird dadurch ein Tool zu geben, welche Einrichtungen im Umkreis bezueglich freier Kapazitaeten anzeigt um somit die Auslastung der Krankenhaeuser effizienter gestalten zu koennen. Ebenso soll es somit erleichtert werden, Krisengebiete schnell auf der Karte sichtbar zu machen und durch entsprechende Erweiterungen mithilfe von Predictive Modelling zukuenftige Kriesengebiete fruehzeitig zu erkennen. Somit wird die rechtzeitige Planung entsprechender Massnahmen effektiver. Das Predictive Modelling kann auf den zusammengetragenen Daten (Zeitreihen zu lokalisierten Faellen und Kapazitaeten), ist aber mangels Zeit noch nicht implementiert.", tags$br(), tags$br(), 
                                "Ferner unterscheidet die Plattform Nutzergruppen und ist datenbankzentriert, um unvorhersehbare Herausforderungen flexibel koordinieren zu koennen - Idee: Keine 10.000 verschiedene Plattformen fuer einzelne Probleme wie Helferboerse, Krankenhausverfuegbarkeit, Schutzmaskenallokation oder Rueckflugsplanung, sondern eine einziges Datenbanksystem fuer alle COVID-19-relevanten Herausforderungen. Wenn etwas neues hinzukommt, sollen einfach ein weiterer Tab und eine weitere Checkbox fuer der Karte entstehen.",tags$br(),
                            tags$br(),
                            tags$h4("Umsetzung"),
                            "Aufgrund der Tatsache, dass wir ein zwei Personen Team sind und somit unsere Ressourcen eingeschraenkt sind haben wir mit einem Fork des folgenden Dashboards begonnen:", tags$br(),
                           tags$br(), 
                            tags$a(href="https://github.com/eparker12/nCoV_tracker", "https://github.com/eparker12/nCoV_tracker"), tags$br(), 
                           tags$br(),
                            "Wir konzentrieren uns auf die Funktionalitaet, dass Krankenhaeuser oder andere Nutzer mit entsprechender Berechtigung Daten eingeben koennen. Denkbar waere eine Nutzung, die zentral durch den Bund koordiniert wird. Insbesondere ist es hier besonders einfach in R entwickelte Vorhersagetools einzubinden und Trend Predictions live in der Karte zu simulieren. Ebenso ist eine Anbindung an bestehende Datenbanken und ein schnelles Deployment auf Servern moeglich. Vor allem aber lassen sich schnell weitere Tools in das Framework einbinden, um die oben genannte Modularitaet fuer unvorhergesehene oder dringende Herausforderungen zu gewaehrleisten.",tags$br(),

                            tags$br(), tags$br(),
                            "und konzentrierten uns darauf die Funktionalitaet fuer das Sammeln von Daten von Krankenhaeusern zu erweitern. Insbesondere ist es hier besonders einfach in R entwickelte Vorhersagetools einzubinden und somit auch beliebig komplexe vorhersagen einbinden zu koennen. Ebenso ist eine Anbindung an Datenbanken und ein schnelles Deplayment auf Servern moeglich. Insbesondere lassen sich schnell nneue Tools in das Framework einbinden.",
                            tags$br(),tags$br(),

                            tags$h4("Referenzen"),
                            "Karte ",tags$a(href="https://www.bbc.co.uk/programmes/w3csym33", "Science in Action."),
                            "Daten ",tags$a(href="https://github.com/eparker12/nCoV_tracker", "Github."),
                            tags$a(href="https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data/csse_covid_19_time_series", "Johns Hopkins Center for Systems Science and Engineering github page,"), tags$a(href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/situation-reports", "WHO's COVID-19 situation reports."),
                             tags$a(href="https://www.who.int/csr/disease/swineflu/updates/en/", "WHO situation reports"),tags$br(), 
                            tags$a(href="https://gist.github.com/tadast/8827699", "Github"),tags$br(),
                            tags$br(),tags$br(),tags$h4("Authoren"),
                            "Felix Reinbott & Borui Zhu",
                            tags$br(),
                            tags$h4("Authoren des Forks"),
